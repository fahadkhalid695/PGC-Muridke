          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full font-semibold transition-all text-center"
              >
                Contact Admissions
              </a>
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white hover:bg-gray-50 text-primary border-2 border-primary px-8 py-3 rounded-full font-semibold transition-all text-center"
              >
